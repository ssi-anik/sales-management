...
import com.example.anik.agent.adapters.ProductListViewAdapter;
...
public class SelectProductActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(String.format("%s for %s", Character.toString(next.charAt(0)).toUpperCase() + next.substring(1), AppCart.getShop().getCompanyName()));
