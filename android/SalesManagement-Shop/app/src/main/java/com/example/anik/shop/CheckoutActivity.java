...
import com.example.anik.shop.adapters.CheckoutListViewAdapter;
...
import com.example.anik.shop.database.Quick;
...
public class CheckoutActivity extends AppCompatActivity {
        ...
        public void onClick(View v) {
            ...
            if (next.equals("order")) {
                ...
                for (Product product : AppCart.getCart()) {
                    ...
                    row.put("order_for", AppStorage.getUserMobileNumber());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(String.format("Checkout %s", next));
