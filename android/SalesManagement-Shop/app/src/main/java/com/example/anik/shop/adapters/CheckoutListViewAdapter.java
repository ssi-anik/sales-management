...
public class CheckoutListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (AppStorage.getNextIntent().equals("quick order")) {
            viewHolder.totalPriceForCheckout.setText(String.format("Rs. %s", product.getTotalPriceWithoutTax()));
            ...
            viewHolder.totalPriceForCheckout.setText(String.format("Rs. %s", product.getTotalPriceWithTax()));
