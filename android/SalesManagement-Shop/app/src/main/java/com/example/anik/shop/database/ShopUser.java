 ...
 */
public class ShopUser extends Database {
    SQLiteDatabase db;
    Cursor cursor;
    String table;
    ...
    public Map<String, String> getUser() {
        ...
        String agent_mobile_number = cursor.getString(cursor.getColumnIndex("agent_mobile_number"));
        ...
        map.put("agent_mobile_number", agent_mobile_number);
        map.put("email", email);
