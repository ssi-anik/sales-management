...
public class AppConstant {
    ...
    public static final String TAG = "com.example.anik.shop";

    public static final String DATABASE_NAME = "sales_shop.db";
    public static final int DATABASE_VERSION = 1;
    public static final String USER_TYPE = "shop";

    public static final String APP_STORAGE_FOLDER = "sales_of_shop";
	...
	private static final String APP_SERVER = PROTOCOL + "WEBSITE_URL";
	private static final String TEST_SERVER = PROTOCOL + "WEBSITE_URL";
