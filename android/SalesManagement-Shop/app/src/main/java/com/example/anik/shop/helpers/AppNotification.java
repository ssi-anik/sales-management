...
import com.example.anik.shop.AllComplaintActivity;
import com.example.anik.shop.BillListActivity;
import com.example.anik.shop.OrderListActivity;
import com.example.anik.shop.R;
import com.example.anik.shop.ShowProduct;
...
public class AppNotification {
    ...
    public static void send() {
        ...
        instance.notificationManager.notify(1124, mBuilder.build());
        instance = null;
    }
