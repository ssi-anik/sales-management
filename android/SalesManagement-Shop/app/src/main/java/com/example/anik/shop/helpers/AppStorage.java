...
public class AppStorage extends Application {
    ...
    public static String getOrderAbleProductList() {
        return orderAbleProductList;
    }

    public static void setOrderAbleProductList(String orderAbleProductList) {
        AppStorage.orderAbleProductList = orderAbleProductList;
    }
    ...
    public static String getAgentMobileNumber() {
        return agentMobileNumber;
    }

    public static void setAgentMobileNumber(String agentMobileNumber) {
        AppStorage.agentMobileNumber = agentMobileNumber;
    }
