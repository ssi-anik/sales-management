...
<div class="row">
  ...
  <form class="form-horizontal" accept-charset="UTF-8" action="" method="POST">
          <div class="col-sm-12"><br>
            ...
            <div class="col-sm-6">
              <input type="text" value="Jane Austinn" name="client_name" id="inputEmail3" class="form-control">
            </div>
          </div>
          ...
          <div class="col-sm-12"><br>
            ...
            <div class="col-sm-6">
              <input type="text" value="deepak" name="client_name" id="inputEmail3" class="form-control">
            </div>
          </div>
          ...
          <div class="col-sm-12"><br>
            ...
            <div class="col-sm-6">
              <input type="email" value="Jane Austinn" name="client_name" id="inputEmail3" class="form-control">
            </div>
          </div>
          ...
          <div class="col-sm-12"><br>
            ...
            <div class="col-sm-6">
              <input type="password" value="password" name="client_name" id="inputEmail3" class="form-control">
            </div>
          </div>
