...
<div class="row">
        <h3>Completed Order<code class="pull-right text-muted">Agent Name</code></h3>
  <div class="col-xs-6 col-md-3">
    <ul class="nav nav-pills nav-stacked sidebarcolor">
      <li class="">{{ HTML::decode(HTML::link('agent/view',' Home (name) ')) }}</li>
      <li>{{ HTML::decode(HTML::link('agent/order',' New Order ')) }}</li>
      <li class="active">{{ HTML::decode(HTML::link('agent/completed',' Completed Order ')) }}</li>
