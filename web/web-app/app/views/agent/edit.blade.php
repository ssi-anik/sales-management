...
<div class="row">
  ...
  <div class="col-xs-6 col-md-3">
    <ul class="nav nav-pills nav-stacked sidebarcolor">
      ...
      <li  class="active">{{ HTML::decode(HTML::link('agent/edit',' Edit Account ')) }}</li>
  ...
  <form class="form-horizontal" accept-charset="UTF-8" action="" method="POST">
      <div class="col-sm-12">
          <div class="col-sm-12">
            <label class="col-sm-4 control-label" for="inputEmail3">Name of Agent :</label>
            <div class="col-sm-8">
              <input type="text" name="client_name" id="inputEmail3" class="form-control" {{ $data->agent_name ? "value='$data->agent_name'" : "placeholder='Enter agent name here'"}}>
            </div>
          </div>
          ...
          <div class="col-sm-12"><br>
            ...
            <div class="col-sm-8">
              <input type="text" name="client_name" id="inputEmail3" class="form-control" {{ $data->email ? "value='$data->email'" : "placeholder='Enter agent email here'"}}>
            </div>
          </div>
          ...
          <div class="col-sm-12"><br>
            ...
            <div class="col-sm-8">
              <input type="text" value="{{$data->phone}}" name="client_name" id="inputEmail3" class="form-control" disabled>
            </div>
          </div>
          ...
          <div class="col-sm-12"><br>
            <label class="col-sm-4 control-label" for="inputEmail3">Correspondence Address :</label>
            <div class="col-sm-8">
              <textarea row="3" col="3" class="form-control" {{ empty($data->address) ? "placeholder='Enter agent address here'" : ''}}>{{ isset($data->address) ? $data->address : ''}}</textarea>
          ...
          <!--<div class="col-sm-12"><br>
            ...
            <div class="col-sm-8">
              <input type="text" value="" name="client_name" id="inputEmail3" class="form-control" disabled>
            </div>
          </div>-->

          <div class="col-sm-12"><br>
            <label class="col-sm-4 control-label" for="inputEmail3">Proof :</label>
            <div class="col-sm-8">
              <input type="text" name="client_name" id="inputEmail3" class="form-control" {{ $data->proof ? "value='$data->proof'" : "placeholder='Enter agent proof type here'"}}>
            </div>
          </div>

          <div class="col-sm-12"><br>
            <label class="col-sm-4 control-label" for="inputEmail3">Agent Picture :</label>
            <div class="col-sm-8">
              <input type="file" name="agent_picture" id="inputEmail3" class="">
            </div>
          </div>

          <div class="col-sm-12"><br>
            <label class="col-sm-4 control-label" for="inputEmail3">Proof Picture :</label>
            <div class="col-sm-8">
              <input type="file" name="proof_picture" id="inputEmail3" class="">
            </div>
          </div>
