...
<div class="row">
  ...
  <div class="col-xs-6 col-md-3">
    <ul class="nav nav-pills nav-stacked sidebarcolor">
      <li class="active">{{ HTML::decode(HTML::link('agent/view/'.$data->id,' Home (name) ')) }}</li>
      ...
      <li>{{ HTML::decode(HTML::link('agent/edit/'.$data->id,' Edit Account ')) }}</li>
      <li>{{ HTML::decode(HTML::link('agent/track/'.$data->id,' Track Agent ')) }}</li>
  ...
  <form class="form-horizontal" accept-charset="UTF-8" action="" method="POST">
      <div class="col-sm-8">
          <div class="col-sm-12">
            ...
            <label class="col-sm-7 control-label center text-muted" for="inputEmail3"> {{ $data->agent_name ? : 'No name is set'}} </label>
            
          </div>

          <div class="col-sm-12"><br>
            <label class="col-sm-5 control-label" for="inputEmail3">Mobile Number (APP) :</label>
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3"> {{$data->phone}} </label>
          </div>

          <div class="col-sm-12"><br>
            <label class="col-sm-5 control-label" for="inputEmail3">Email :</label>
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3"> {{ $data->email ? : 'No email is set'}} </label>
          </div>
          ...
          <div class="col-sm-12"><br>
            ...
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3">{{ $data->address ? : 'No address is set'}}</label>
          </div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d219525.5850271858!2d76.70811554490176!3d30.715947028894835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fed0be66ec96b%3A0xa5ff67f9527319fe!2sChandigarh!5e0!3m2!1sen!2sin!4v1427163959509" width="200" height="120" frameborder="0" style="border:0"></iframe>
          ...
          <div class="col-sm-12"><br>
            ...
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3">{{ $data->proof ? : 'No proof is set'}}</label>
          </div>

          <div class="col-sm-12"><br>
            <label class="col-sm-5 control-label" for="inputEmail3">Authenticate Code :<br/><span class="text-muted">(app install) </span></label>
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3">{{$data->activate}}</label>
          </div>

          <div class="col-sm-12"><br>
            <label class="col-sm-5 control-label" for="inputEmail3">Created On :<br/><span class="text-muted">(Date) </span></label>
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3">{{explode(" ", $data->created_at)[0]}}</label>
          </div>
