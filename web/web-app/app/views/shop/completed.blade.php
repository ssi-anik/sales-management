...
<div class="row">
        <h3>Completed Order<code class="pull-right text-muted">Company Name</code></h3>
  <div class="col-xs-6 col-md-3">
    <ul class="nav nav-pills nav-stacked sidebarcolor">
      <li class="">{{ HTML::decode(HTML::link('shop/view',' Home (name) ')) }}</li>
      <li>{{ HTML::decode(HTML::link('shop/order',' New Order ')) }}</li>
      <li class="active">{{ HTML::decode(HTML::link('shop/completed',' Completed Order ')) }}</li>
