...
<div class="row">
  ...
  <form class="form-horizontal" accept-charset="UTF-8" action="" method="POST">
      <div class="col-sm-8">
          <div class="col-sm-12">
            <label class="col-sm-5 control-label" for="inputEmail3">Name of Shop :</label>
            <label class="col-sm-7 control-label center text-muted" for="inputEmail3">Goyal Music</label>
            
          </div>

          <div class="col-sm-12"><br>
            <label class="col-sm-5 control-label" for="inputEmail3">Name of Owner (phone) :</label>
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3">Abc ( 9592323298 )</label>
          </div>
          ...
          <div class="col-sm-12"><br>
            <label class="col-sm-5 control-label" for="inputEmail3">Company Address :</label>
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3">address here</label>
          </div>

          <div class="col-sm-12"><br>
            <label class="col-sm-5 control-label" for="inputEmail3">Location of Company :</label>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d219525.5850271858!2d76.70811554490176!3d30.715947028894835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fed0be66ec96b%3A0xa5ff67f9527319fe!2sChandigarh!5e0!3m2!1sen!2sin!4v1427163959509" width="200" height="120" frameborder="0" style="border:0"></iframe>
          ...
          <div class="col-sm-12"><br>
            <label class="col-sm-5 control-label" for="inputEmail3">Category of Shop :</label>
            <label class="col-sm-7 control-label  center text-muted" for="inputEmail3">category here</label>
          </div>
      ...
      <div class="col-sm-4">
        <h4 class="text-muted">Company Picture</h4>
         ...
         <h4 class="text-muted">Owner Picture</h4>
            <img src="data:image/svg+xml;base64," class="img-rounded" />
